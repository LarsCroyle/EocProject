...
return function(Props)
    ...
    local HotbarItem;
    HotbarItem = New "Frame" {
        Name = "Item" .. Props.Position,
        BackgroundTransparency = 0.5,
        Size = UDim2.new(0.068, 0, 0.95, 0),
        ...
        [Children] = {
            ...
            New "TextButton" {
                ...
                [OnEvent "MouseButton1Down"] = function(X, Y)
                    DraggingItem(HotbarItem, X, Y)
                end,
                [OnEvent "MouseEnter"] = function()
                    ShowFlavorText(HotbarItem, Props.ItemName:get(), true, Props.MenuOpen)
                end,
                [OnEvent "MouseLeave"] = function()
                    ShowFlavorText(HotbarItem, Props.ItemName:get(), false)
                end,
            },
            New "ImageLabel" {
                Name = "BorderFrame",
    ...
    HotbarItem:SetAttribute("ItemContainer", true)
